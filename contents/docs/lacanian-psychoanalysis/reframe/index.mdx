...
weight: "1"
---
Artificial Intelligence, at its core, emerges from one fundamental ambition: to replicate, emulate, and perhaps even transcend the capacities of the human mind. From the most essential question that urges us to build functional human-like machines, "what does it truly mean to mimic cognition?", to every nontrivial engineering decision, researchers have approached this challenge through a spectrum of paradigms. The most notable ones are neuroscience‑inspired models, striving for biological fidelity, emulating spiking networks, and cognitive architectures (e.g., ACT‑R, Soar, Global Workspace Theory) that formalize high‑level processes of memory, attention, and reasoning. ~~Symbolic logic and knowledge representation leverage ontologies, theorem proving, and rule‑based inference to approximate human deliberation.~~ Among these popular attempts, their foundations centers at the computational statistics and deep learning. As the paper *Geometric Deep Learning Grids, Groups, Graphs, Geodesics, and Gauges* beautifully summarized for the two simple algorithmic principles for DL: "first, the notion of representation or feature learning, whereby adapted, often hierarchical, features capture the appropriate notion of regularity for each task, and second, learning by local gradient-descent, typically implemented as backpropagation." The effect of these principles were sheerly exemplified by contemporary large language models (LLMs) in the last several years. They managed to demonstrate that the data‑driven pattern extraction, optimizing over massive corpora via autoregressive likelihood objectives, is not only feasible, but results in human-like behavior.
...
Despite this methodological diversity, the prevailing paradigm within mainstream AI—especially visible in LLMs—is dominated by predictive mechanisms. These systems function primarily as sophisticated statistical engines: autoregressive predictors whose sole objective is to maximize the probability of the next token given the preceding context. Their linguistic prowess and surface‑level coherence mask a conceptual simplicity: at heart, they are reactive mirrors of statistical regularities learned from vast textual corpora.
...
Integrating topological and geometric insights with existing AI architectures thus represents more than an incremental advance—it constitutes a conceptual rupture. By embedding within AI systems formal structures of irreducible lack and self‑referential loops, we can endow them with the bedrock of genuine autonomous drives. This ambitious agenda demands a rigorous synthesis of advanced mathematical theory, scalable computational algorithms, and novel theoretical perspectives.

Positioning topology and geometry at the center of next‑generation AI research compels a radical rethinking: moving from machines that predict and mimic toward systems that desire, explore, and create from within. The limitations of current paradigms are clear, and the need for new foundational principles is urgent. Only by rigorously harnessing the potency of mathematics—persistent homology, symplectic flows, information geometry, and beyond—can we aspire to forge artificial intelligences that sustain their own trajectories of discovery and creativity.
